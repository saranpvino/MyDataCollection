...
public class LearnList {
	 ...
	 * grow or shrink !!
	 * 
	 * List - Interface - Implemented using several classes like ArrayList,
	 * LinkedList - Single Dimensional data structure - Allows Duplicate data to be
	 * stored - Order is maintained in the order of insertion - Highly used Methods:
	 * - add : to add element to the list (at the end) - remove - get - size -
	 * contains - How to sort a list? Collections.sort(lst)
	 */
		...
		System.out.println("SIZE: "+mentorsList.size());
		mentorsList.remove("Dhivya");
		mentorsList.remove(0);//overloading
		System.out.println("CONTAINS OR NOT: "+mentorsList.contains("Babu"));
		
		System.out.println("LIST: "+mentorsList);
		//System.out.println(mentorsList.contains("Dhivya"));
		// Class -> Collections
